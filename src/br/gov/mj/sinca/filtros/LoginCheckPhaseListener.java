...
public class LoginCheckPhaseListener implements PhaseListener {
	...
	// armazenando a página que fez a requisição. (a string da pág. atual
	// ex: "/pag.jsf")
	...
	if (isLoginPage) {
	    ...
	    Boolean usuAtt = (Boolean) JSFUtil.getHttpSession().getAttribute("USUARIO_AUTENTICADO");
	    if(usuAtt!=null){
		usuarioAutenticado = usuAtt;
	    }
	}
	// LoginMB loginMB = (LoginMB)
	// JSFUtil.getVariavelApplication("loginMB");
	// if (loginMB != null){
