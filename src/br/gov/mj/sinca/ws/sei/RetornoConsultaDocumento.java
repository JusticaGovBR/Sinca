...
public class RetornoConsultaDocumento  implements java.io.Serializable {
    ...
    private br.gov.mj.sinca.ws.sei.Serie serie;

    private java.lang.String numero;

    private java.lang.String data;

    private br.gov.mj.sinca.ws.sei.Unidade unidadeElaboradora;

    private br.gov.mj.sinca.ws.sei.Andamento andamentoGeracao;

    private br.gov.mj.sinca.ws.sei.Assinatura[] assinaturas;

    private br.gov.mj.sinca.ws.sei.Publicacao publicacao;
    ...
    public RetornoConsultaDocumento(
           ...
           br.gov.mj.sinca.ws.sei.Serie serie,
           java.lang.String numero,
           java.lang.String data,
           br.gov.mj.sinca.ws.sei.Unidade unidadeElaboradora,
           br.gov.mj.sinca.ws.sei.Andamento andamentoGeracao,
           br.gov.mj.sinca.ws.sei.Assinatura[] assinaturas,
           br.gov.mj.sinca.ws.sei.Publicacao publicacao) {
     ...
     * @return serie
     */
    public br.gov.mj.sinca.ws.sei.Serie getSerie() {
        return serie;
    }
     ...
     * @param serie
     */
    public void setSerie(br.gov.mj.sinca.ws.sei.Serie serie) {
        this.serie = serie;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.Unidade getUnidadeElaboradora() {
        return unidadeElaboradora;
    }
     ...
     */
    public void setUnidadeElaboradora(br.gov.mj.sinca.ws.sei.Unidade unidadeElaboradora) {
        this.unidadeElaboradora = unidadeElaboradora;
    }
     ...
     * @return assinaturas
     */
    public br.gov.mj.sinca.ws.sei.Assinatura[] getAssinaturas() {
        return assinaturas;
    }
     ...
     * @param assinaturas
     */
    public void setAssinaturas(br.gov.mj.sinca.ws.sei.Assinatura[] assinaturas) {
        this.assinaturas = assinaturas;
    }
     ...
     * @return publicacao
     */
    public br.gov.mj.sinca.ws.sei.Publicacao getPublicacao() {
        return publicacao;
    }
     ...
     * @param publicacao
     */
    public void setPublicacao(br.gov.mj.sinca.ws.sei.Publicacao publicacao) {
        this.publicacao = publicacao;
    }
