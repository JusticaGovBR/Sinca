...
public class Andamento  implements java.io.Serializable {
    ...
    private br.gov.mj.sinca.ws.sei.Usuario usuario;
    ...
    public Andamento(
           ...
           br.gov.mj.sinca.ws.sei.Usuario usuario) {
     ...
     * @return usuario
     */
    public br.gov.mj.sinca.ws.sei.Usuario getUsuario() {
        return usuario;
    }
     ...
     * @param usuario
     */
    public void setUsuario(br.gov.mj.sinca.ws.sei.Usuario usuario) {
        this.usuario = usuario;
    }
