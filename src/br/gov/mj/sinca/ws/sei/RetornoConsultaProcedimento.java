...
public class RetornoConsultaProcedimento  implements java.io.Serializable {
    ...
    private br.gov.mj.sinca.ws.sei.TipoProcedimento tipoProcedimento;

    private br.gov.mj.sinca.ws.sei.Andamento andamentoGeracao;

    private br.gov.mj.sinca.ws.sei.Andamento andamentoConclusao;

    private br.gov.mj.sinca.ws.sei.Andamento ultimoAndamento;

    private br.gov.mj.sinca.ws.sei.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto;

    private br.gov.mj.sinca.ws.sei.Assunto[] assuntos;

    private br.gov.mj.sinca.ws.sei.Interessado[] interessados;

    private br.gov.mj.sinca.ws.sei.Observacao[] observacoes;

    private br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] procedimentosRelacionados;

    private br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] procedimentosAnexados;
    ...
    public RetornoConsultaProcedimento(
           ...
           br.gov.mj.sinca.ws.sei.TipoProcedimento tipoProcedimento,
           br.gov.mj.sinca.ws.sei.Andamento andamentoGeracao,
           br.gov.mj.sinca.ws.sei.Andamento andamentoConclusao,
           br.gov.mj.sinca.ws.sei.Andamento ultimoAndamento,
           br.gov.mj.sinca.ws.sei.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto,
           br.gov.mj.sinca.ws.sei.Assunto[] assuntos,
           br.gov.mj.sinca.ws.sei.Interessado[] interessados,
           br.gov.mj.sinca.ws.sei.Observacao[] observacoes,
           br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] procedimentosRelacionados,
           br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] procedimentosAnexados) {
     ...
     */
    public br.gov.mj.sinca.ws.sei.TipoProcedimento getTipoProcedimento() {
        return tipoProcedimento;
    }
     ...
     */
    public void setTipoProcedimento(br.gov.mj.sinca.ws.sei.TipoProcedimento tipoProcedimento) {
        this.tipoProcedimento = tipoProcedimento;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.Andamento getAndamentoGeracao() {
        return andamentoGeracao;
    }
     ...
     */
    public void setAndamentoGeracao(br.gov.mj.sinca.ws.sei.Andamento andamentoGeracao) {
        this.andamentoGeracao = andamentoGeracao;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.Andamento getAndamentoConclusao() {
        return andamentoConclusao;
    }
     ...
     */
    public void setAndamentoConclusao(br.gov.mj.sinca.ws.sei.Andamento andamentoConclusao) {
        this.andamentoConclusao = andamentoConclusao;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.Andamento getUltimoAndamento() {
        return ultimoAndamento;
    }
     ...
     */
    public void setUltimoAndamento(br.gov.mj.sinca.ws.sei.Andamento ultimoAndamento) {
        this.ultimoAndamento = ultimoAndamento;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.UnidadeProcedimentoAberto[] getUnidadesProcedimentoAberto() {
        return unidadesProcedimentoAberto;
    }
     ...
     */
    public void setUnidadesProcedimentoAberto(br.gov.mj.sinca.ws.sei.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto) {
        this.unidadesProcedimentoAberto = unidadesProcedimentoAberto;
    }
     ...
     * @return assuntos
     */
    public br.gov.mj.sinca.ws.sei.Assunto[] getAssuntos() {
        return assuntos;
    }
     ...
     * @param assuntos
     */
    public void setAssuntos(br.gov.mj.sinca.ws.sei.Assunto[] assuntos) {
        this.assuntos = assuntos;
    }
     ...
     * @return interessados
     */
    public br.gov.mj.sinca.ws.sei.Interessado[] getInteressados() {
        return interessados;
    }
     ...
     * @param interessados
     */
    public void setInteressados(br.gov.mj.sinca.ws.sei.Interessado[] interessados) {
        this.interessados = interessados;
    }
     ...
     * @return observacoes
     */
    public br.gov.mj.sinca.ws.sei.Observacao[] getObservacoes() {
        return observacoes;
    }
     ...
     * @param observacoes
     */
    public void setObservacoes(br.gov.mj.sinca.ws.sei.Observacao[] observacoes) {
        this.observacoes = observacoes;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] getProcedimentosRelacionados() {
        return procedimentosRelacionados;
    }
     ...
     */
    public void setProcedimentosRelacionados(br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] procedimentosRelacionados) {
        this.procedimentosRelacionados = procedimentosRelacionados;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] getProcedimentosAnexados() {
        return procedimentosAnexados;
    }
     ...
     */
    public void setProcedimentosAnexados(br.gov.mj.sinca.ws.sei.ProcedimentoResumido[] procedimentosAnexados) {
        this.procedimentosAnexados = procedimentosAnexados;
    }
