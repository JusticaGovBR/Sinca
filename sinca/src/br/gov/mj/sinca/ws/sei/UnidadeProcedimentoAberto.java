...
public class UnidadeProcedimentoAberto  implements java.io.Serializable {
    private br.gov.mj.sinca.ws.sei.Unidade unidade;

    private br.gov.mj.sinca.ws.sei.Usuario usuarioAtribuicao;

    public UnidadeProcedimentoAberto() {
    }

    public UnidadeProcedimentoAberto(
           br.gov.mj.sinca.ws.sei.Unidade unidade,
           br.gov.mj.sinca.ws.sei.Usuario usuarioAtribuicao) {
     ...
     * @return unidade
     */
    public br.gov.mj.sinca.ws.sei.Unidade getUnidade() {
        return unidade;
    }
     ...
     * @param unidade
     */
    public void setUnidade(br.gov.mj.sinca.ws.sei.Unidade unidade) {
        this.unidade = unidade;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.Usuario getUsuarioAtribuicao() {
        return usuarioAtribuicao;
    }
     ...
     */
    public void setUsuarioAtribuicao(br.gov.mj.sinca.ws.sei.Usuario usuarioAtribuicao) {
        this.usuarioAtribuicao = usuarioAtribuicao;
    }
