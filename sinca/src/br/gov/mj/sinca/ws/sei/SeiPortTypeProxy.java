...
public class SeiPortTypeProxy implements br.gov.mj.sinca.ws.sei.SeiPortType {
  private String _endpoint = null;
  private br.gov.mj.sinca.ws.sei.SeiPortType seiPortType = null;
  ...
  private void _initSeiPortTypeProxy() {
    try {
      seiPortType = (new br.gov.mj.sinca.ws.sei.SeiServiceLocator()).getSeiPortService();
      if (seiPortType != null) {
        if (_endpoint != null)
  ...
  public br.gov.mj.sinca.ws.sei.SeiPortType getSeiPortType() {
    if (seiPortType == null)
      _initSeiPortTypeProxy();
    return seiPortType;
  }
