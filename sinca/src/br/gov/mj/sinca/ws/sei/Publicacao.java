...
public class Publicacao  implements java.io.Serializable {
    ...
    private br.gov.mj.sinca.ws.sei.PublicacaoImprensaNacional imprensaNacional;
    ...
    public Publicacao(
           ...
           br.gov.mj.sinca.ws.sei.PublicacaoImprensaNacional imprensaNacional) {
     ...
     */
    public br.gov.mj.sinca.ws.sei.PublicacaoImprensaNacional getImprensaNacional() {
        return imprensaNacional;
    }
     ...
     */
    public void setImprensaNacional(br.gov.mj.sinca.ws.sei.PublicacaoImprensaNacional imprensaNacional) {
        this.imprensaNacional = imprensaNacional;
    }
