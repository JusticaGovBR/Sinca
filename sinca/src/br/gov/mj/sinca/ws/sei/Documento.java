...
public class Documento  implements java.io.Serializable {
    ...
    private br.gov.mj.sinca.ws.sei.Remetente remetente;

    private br.gov.mj.sinca.ws.sei.Interessado[] interessados;

    private br.gov.mj.sinca.ws.sei.Destinatario[] destinatarios;
    ...
    public Documento(
           ...
           br.gov.mj.sinca.ws.sei.Remetente remetente,
           br.gov.mj.sinca.ws.sei.Interessado[] interessados,
           br.gov.mj.sinca.ws.sei.Destinatario[] destinatarios,
     ...
     * @return remetente
     */
    public br.gov.mj.sinca.ws.sei.Remetente getRemetente() {
        return remetente;
    }
     ...
     * @param remetente
     */
    public void setRemetente(br.gov.mj.sinca.ws.sei.Remetente remetente) {
        this.remetente = remetente;
    }
     ...
     */
    public br.gov.mj.sinca.ws.sei.Destinatario[] getDestinatarios() {
        return destinatarios;
    }
     ...
     * @param destinatarios
     */
    public void setDestinatarios(br.gov.mj.sinca.ws.sei.Destinatario[] destinatarios) {
        this.destinatarios = destinatarios;
    }
