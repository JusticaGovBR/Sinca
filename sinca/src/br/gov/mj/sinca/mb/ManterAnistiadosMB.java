...
@ManagedBean(name = "manterAnistiadoMB")
@RequestScoped
public class ManterAnistiadosMB implements Serializable {
    ...
    private List<Pessoa> listarPessoaAnistiado = new ArrayList<Pessoa>();
    ...
    private Pessoa pessoaAnistiado = new Pessoa();
    private Pessoa pessoaAnistCadasto = new Pessoa();
	...
	try {
	    ...
	    Pessoa pessoaSalva = pessoaDao.salvar(pessoaAnistCadasto);
	    ...
	    if(JSFUtil.getSessionMap().get(ConstantSinca.PESSOA_SALVA_ANISTIADO_PROPOSTA)==null || 
		    ((Pessoa) JSFUtil.getSessionMap().get(ConstantSinca.PESSOA_SALVA_ANISTIADO_PROPOSTA))==null){
	...
	if (pessoa != null) {
	    ...
	    JSFUtil.getSessionMap().put(ConstantSinca.LISTAR_PESSOA_ANISTIADO, new ArrayList<Pessoa>());
    ...
    public List<Pessoa> consultarPessoasJuridica() {
	...
	listarPessoaAnistiado = new ArrayList<Pessoa>();
    ...
    public List<Pessoa> consultarPessoasAnistiada() {
    ...
    private void carregarTelefonePessoa(Pessoa pessoa) {
    ...
    public Pessoa getPessoaAnistiado() {
	return pessoaAnistiado;
    }

    public void setPessoaAnistiado(Pessoa pessoaAnistiado) {
	this.pessoaAnistiado = pessoaAnistiado;
    }

    @SuppressWarnings("unchecked")
    public List<Pessoa> getListarPessoaAnistiado() {
	if (listarPessoaAnistiado.isEmpty()
		&& JSFUtil.getSessionMap().get(ConstantSinca.LISTAR_PESSOA_ANISTIADO) != null) {
	    listarPessoaAnistiado = (List<Pessoa>) JSFUtil.getSessionMap().get(ConstantSinca.LISTAR_PESSOA_ANISTIADO);
	}
	return listarPessoaAnistiado;
    }

    public void setListarPessoaAnistiado(List<Pessoa> listarPessoaAnistiado) {
    ...
    public Pessoa getPessoaAnistCadasto() {
	return pessoaAnistCadasto;
    }

    public void setPessoaAnistCadasto(Pessoa pessoaAnistCadasto) {
